...
// Urutan halte sesuai rute bus — OSRM routing antar halte otomatis ikut jalan
const ROUTE_1_PATH = [
    [-7.0553551, 110.4392964], //  1. Halte Joging Track
    [-7.0536302, 110.4391998], //  2. Halte Baskoro
    [-7.0509097, 110.4371935], //  3. Halte FISIP Hukum
    [-7.0504200, 110.4360992], //  4. Halte FIB Vokasi
    [-7.0498503, 110.4384971], //  5. Halte Widpur
    [-7.0487483, 110.4402190], //  6. Halte Samwa
    [-7.0471884, 110.4387009], //  7. Halte Psiko
    [-7.0476915, 110.4410277], //  8. Halte FEB
    [-7.0489452, 110.4425284], //  9. Halte FKM
    [-7.0507341, 110.4420429], // 10. Halte FPIK
    [-7.0530393, 110.4412919], // 11. Halte FPP
    [-7.0545672, 110.4396236], // 12. Halte FPP After Sapi
    [-7.0560116, 110.4393959], // 13. Halte Bundaran UNDIP
    [-7.0545246, 110.4441404], // 14. Halte Rusunawa
    [-7.0553551, 110.4392964], // 15. Kembali ke Halte Joging Track
];
