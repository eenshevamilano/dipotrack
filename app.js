...
// Rute bus UNDIP — waypoint mengikuti jalan sesuai peta Koridor Tembalang
const ROUTE_1_PATH = [

    // ── 1. JOGING TRACK (start)
    [-7.0553551, 110.4392964],

    // ── ke utara lurus Jl. Prof. Eko Budiharjo ──
    [-7.0549000, 110.4392800],
    [-7.0544000, 110.4392500],
    [-7.0540000, 110.4392200],
    [-7.0536302, 110.4391998], // BASKORO

    // ── dari Baskoro belok kiri (barat daya) ──
    // ikut Jl. Baskoro lalu masuk Jl. Prof. Soedarto arah barat
    [-7.0530000, 110.4388000],
    [-7.0524000, 110.4382000],
    [-7.0518000, 110.4377000],
    [-7.0513000, 110.4374000],
    [-7.0509097, 110.4371935], // FISIP HUKUM

    // ── FISIP → FIB, lurus ke barat sedikit ──
    [-7.0507000, 110.4368000],
    [-7.0505500, 110.4364500],
    [-7.0504200, 110.4360992], // FIB VOKASI

    // ── FIB balik ke timur laut (U-turn kecil) ──
    // turun ke Jl. Prof. Soedarto arah timur
    [-7.0501500, 110.4363500],
    [-7.0499500, 110.4368000],
    [-7.0498800, 110.4374000],
    [-7.0498600, 110.4380000],
    [-7.0498503, 110.4384971], // WIDPUR

    // ── Widpur → Samwa, lurus timur di Jl. Prof. Soedarto ──
    [-7.0491500, 110.4391000],
    [-7.0488500, 110.4397000],
    [-7.0487483, 110.4402190], // SAMWA

    // ── Samwa → Psiko, belok kiri ke barat (Jl. Prof. Mr. Sunario) ──
    [-7.0481500, 110.4399000],
    [-7.0477500, 110.4395000],
    [-7.0474500, 110.4390500],
    [-7.0471884, 110.4387009], // PSIKO

    // ── Psiko balik ke timur (Jl. Prof. Mr. Sunario) ──
    [-7.0473000, 110.4390500],
    [-7.0474500, 110.4396500],
    [-7.0475500, 110.4403000],
    [-7.0476915, 110.4410277], // FEB

    // ── FEB → FKM, naik ke utara (Jl. Prof. Jacub Rais) ──
    [-7.0481500, 110.4414500],
    [-7.0485500, 110.4419000],
    [-7.0489452, 110.4425284], // FKM

    // ── FKM → FPIK, turun ke selatan ──
    [-7.0494000, 110.4424000],
    [-7.0500500, 110.4422000],
    [-7.0507341, 110.4420429], // FPIK

    // ── FPIK → FPP, terus selatan ──
    [-7.0514500, 110.4418500],
    [-7.0522000, 110.4416000],
    [-7.0530393, 110.4412919], // FPP

    // ── FPP → FPP After Sapi, belok barat ke Jl. Prof. Soedarto ──
    [-7.0535500, 110.4408000],
    [-7.0540500, 110.4403000],
    [-7.0543000, 110.4399000],
    [-7.0545672, 110.4396236], // FPP AFTER SAPI

    // ── FPP After Sapi → Bundaran, lurus selatan ──
    [-7.0550000, 110.4395500],
    [-7.0555000, 110.4394500],
    [-7.0560116, 110.4393959], // BUNDARAN UNDIP

    // ── Bundaran → Rusunawa, belok kiri ke timur (Jl. Prof. Soedarto) ──
    [-7.0560500, 110.4399000],
    [-7.0558000, 110.4408000],
    [-7.0555500, 110.4417000],
    [-7.0552500, 110.4426000],
    [-7.0549500, 110.4434000],
    [-7.0547000, 110.4438500],
    [-7.0545246, 110.4441404], // RUSUNAWA

    // ── Rusunawa → Joging Track, balik barat lurus (Jl. Prof. Soedarto) ──
    [-7.0547500, 110.4436000],
    [-7.0549500, 110.4428000],
    [-7.0551500, 110.4419000],
    [-7.0552500, 110.4411000],
    [-7.0553000, 110.4404000],
    [-7.0553551, 110.4392964], // JOGING TRACK (end)
];
...
function drawRoutePolylines() {
    ...
    // Gambar rute langsung dari ROUTE_1_PATH (sudah mengikuti jalan kampus)
    L.polyline(ROUTE_1_PATH, {
