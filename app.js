...
const ROUTE_1_PATH = [
    ...
    // Jl. Prof. Eko Budiharjo, lurus ke utara
    [-7.0553551, 110.4392964], // Joging Track
    [-7.0548000, 110.4392700],
    [-7.0542000, 110.4392400],
    [-7.0536302, 110.4391998], // Baskoro

    // ── BASKORO → FISIP HUKUM ──
    // Belok kiri (barat), masuk Jl. Prof. Soedarto menuju barat
    [-7.0527000, 110.4388000],
    [-7.0519000, 110.4381000],
    [-7.0514000, 110.4376500],
    [-7.0509097, 110.4371935], // FISIP Hukum

    // ── FISIP HUKUM → FIB VOKASI ──
    // Terus ke barat
    [-7.0506000, 110.4366500],
    [-7.0504200, 110.4360992], // FIB Vokasi

    // ── FIB VOKASI → WIDPUR ──
    // U-turn, balik ke timur lewat jalan paralel (sedikit lebih utara)
    [-7.0501000, 110.4362000],
    [-7.0499500, 110.4367500],
    [-7.0499000, 110.4374000],
    [-7.0498700, 110.4380000],
    [-7.0498503, 110.4384971], // Widpur

    // ── WIDPUR → SAMWA ──
    // Jl. Prof. Soedarto ke timur
    [-7.0491500, 110.4390500],
    [-7.0488500, 110.4396500],
    [-7.0487483, 110.4402190], // Samwa

    // ── SAMWA → PSIKO ──
    // Belok kiri ke barat laut (Jl. Prof. Mr. Sunario)
    [-7.0481000, 110.4399000],
    [-7.0477000, 110.4394500],
    [-7.0474000, 110.4390500],
    [-7.0471884, 110.4387009], // Psiko

    // ── PSIKO → FEB ──
    // Balik ke timur, lanjut Jl. Prof. Mr. Sunario
    [-7.0473000, 110.4391000],
    [-7.0474500, 110.4397000],
    [-7.0475500, 110.4403500],
    [-7.0476915, 110.4410277], // FEB

    // ── FEB → FKM ──
    // Jl. Prof. Jacub Rais ke timur laut
    [-7.0481000, 110.4415000],
    [-7.0485500, 110.4420000],
    [-7.0489452, 110.4425284], // FKM

    // ── FKM → FPIK ──
    // Jl. Prof. Jacub Rais ke selatan
    [-7.0495000, 110.4424000],
    [-7.0501000, 110.4422500],
    [-7.0507341, 110.4420429], // FPIK

    // ── FPIK → FPP ──
    // Terus ke selatan
    [-7.0514000, 110.4418500],
    [-7.0522000, 110.4416500],
    [-7.0530393, 110.4412919], // FPP

    // ── FPP → FPP AFTER SAPI ──
    // Belok barat daya, Jl. Prof. Soedarto
    [-7.0535000, 110.4407500],
    [-7.0540000, 110.4402500],
    [-7.0543000, 110.4399000],
    [-7.0545672, 110.4396236], // FPP After Sapi

    // ── FPP AFTER SAPI → BUNDARAN UNDIP ──
    // Lurus ke selatan
    [-7.0550500, 110.4395000],
    [-7.0555500, 110.4394500],
    [-7.0560116, 110.4393959], // Bundaran UNDIP

    // ── BUNDARAN UNDIP → RUSUNAWA ──
    // Belok kiri (timur), Jl. Prof. Soedarto ke timur
    [-7.0560000, 110.4400000],
    [-7.0558000, 110.4410000],
    [-7.0555000, 110.4420000],
    [-7.0552000, 110.4428500],
    [-7.0549000, 110.4434500],
    [-7.0546500, 110.4439000],
    [-7.0545246, 110.4441404], // Rusunawa

    // ── RUSUNAWA → JOGING TRACK ──
    // Jl. Prof. Soedarto lurus ke barat kembali ke Joging Track
    [-7.0547000, 110.4436000],
    [-7.0549500, 110.4430000],
    [-7.0551500, 110.4420000],
