...
// Rute bus mengikuti jalan kampus UNDIP
// Waypoint mengikuti layout jalan nyata berdasarkan peta UNDIP Tembalang
const ROUTE_1_PATH = [

    // 1. Joging Track → Baskoro (lurus ke utara di Jl. Prof. Eko Budiharjo)
    [-7.0553551, 110.4392964],
    [-7.0547500, 110.4392700],
    [-7.0541000, 110.4392300],
    [-7.0536302, 110.4391998],

    // 2. Baskoro → FISIP Hukum (belok kiri ke barat daya, masuk Jl. Prof. Sudarto)
    [-7.0529000, 110.4390500],
    [-7.0522000, 110.4385000],
    [-7.0516000, 110.4379000],
    [-7.0511000, 110.4374500],
    [-7.0509097, 110.4371935],

    // 3. FISIP Hukum → FIB Vokasi (lurus ke barat)
    [-7.0506500, 110.4367000],
    [-7.0504200, 110.4360992],

    // 4. FIB Vokasi → Widpur (balik ke timur, naik ke Jl. Prof. Soedarto)
    [-7.0502000, 110.4364000],
    [-7.0500000, 110.4368000],
    [-7.0499000, 110.4373000],
    [-7.0498800, 110.4379000],
    [-7.0498503, 110.4384971],

    // 5. Widpur → Samwa (ikut Jl. Prof. Soedarto ke timur)
    [-7.0492000, 110.4390000],
    [-7.0489000, 110.4396000],
    [-7.0487483, 110.4402190],

    // 6. Samwa → Psiko (belok kiri ke barat laut, Jl. Prof. Mr. Sunario)
    [-7.0482000, 110.4399000],
    [-7.0478000, 110.4394500],
    [-7.0474500, 110.4390000],
    [-7.0471884, 110.4387009],

    // 7. Psiko → FEB (balik ke timur di Jl. Prof. Mr. Sunario)
    [-7.0473000, 110.4391000],
    [-7.0474500, 110.4397000],
    [-7.0476000, 110.4403500],
    [-7.0476915, 110.4410277],

    // 8. FEB → FKM (ke utara/timur laut, Jl. Prof. Jacub Rais)
    [-7.0481000, 110.4415000],
    [-7.0485000, 110.4419500],
    [-7.0489452, 110.4425284],

    // 9. FKM → FPIK (ke selatan di Jl. Prof. Jacub Rais)
    [-7.0494000, 110.4424000],
    [-7.0500000, 110.4422500],
    [-7.0507341, 110.4420429],

    // 10. FPIK → FPP (terus ke selatan)
    [-7.0514000, 110.4418500],
    [-7.0521000, 110.4416500],
    [-7.0530393, 110.4412919],

    // 11. FPP → FPP After Sapi (belok ke Jl. Prof. Soedarto ke selatan)
    [-7.0535000, 110.4408000],
    [-7.0540000, 110.4403000],
    [-7.0545672, 110.4396236],

    // 12. FPP After Sapi → Bundaran UNDIP (lurus ke selatan)
    [-7.0551000, 110.4395000],
    [-7.0560116, 110.4393959],

    // 13. Bundaran UNDIP → Rusunawa (Jl. Prof. Soedarto ke timur)
    [-7.0558000, 110.4400000],
    [-7.0555000, 110.4410000],
    [-7.0552000, 110.4421000],
    [-7.0549000, 110.4430000],
    [-7.0547000, 110.4436000],
    [-7.0545246, 110.4441404],

    // 14. Rusunawa → Joging Track (balik ke barat via Jl. Prof. Soedarto)
    [-7.0547500, 110.4434000],
    [-7.0550000, 110.4422000],
    [-7.0552000, 110.4410000],
    [-7.0553000, 110.4402000],
    [-7.0553551, 110.4392964],
];
